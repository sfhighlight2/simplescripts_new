...
const HealthGuide: React.FC = () => {
  const articles = [
    ...
    { title: "Cialis® vs. Viagra®: similarities and differences", time: "8 min read", img: "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&q=80&w=300" },
